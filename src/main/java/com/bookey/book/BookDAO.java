...
public class BookDAO {
	...
	private String getMainQuery(Map<String, Object> paramMap) {
		...
		String query = ""
				...
				+ "             , BOOK_STATUS.CODE BOOK_STATUS_CODE, BOOK_STATUS.VALUE BOOK_STATUS, BOOK_APPERANCE.CODE   AS BOOK_APPERANCE_CODE, BOOK_APPERANCE.VALUE AS BOOK_APPERANCE_STATUS"
				+ "          FROM TBL_BOOK BOOK"
				+ "             , ("
