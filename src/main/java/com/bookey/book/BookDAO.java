...
public class BookDAO {
	...
	private String selectMainQuery(Map<String, Object> paramMap) {
		...
		String query = "" 
				...
				+ "        SELECT BOOK.BOOKID" 
				+ "             , BOOK.BOOKNM"
				+ "             , BOOK.PUBLISHER, BOOK.AUTHOR, BOOK.IMAGE_FILE_NAME, TO_CHAR(BOOK.PUBLISHED_DATE, 'YYYY-MM-DD') AS PUBLISHED_DATE, BOOK.STATUS AS BOOK_STATUS"
				...
				+ "             , RENTAL.STATUS AS RENTAL_STATUS_CODE, RENTAL.USERID AS RETAL_USER, RENTAL_STATUS.VALUE AS RENTAL_STATUS_VALUE, TO_CHAR(RENTAL.RENTAL_DATE, 'YYYY-MM-DD') AS RENTAL_DATE, TO_CHAR(RENTAL.DUE_DATE, 'YYYY-MM-DD')    AS RENTAL_DUE_DATE"
